                ...
                <tr>
                    <th class="d-flex align-items-center">
                        ...
                        <button type="button" class="btn btn-sm btn-danger ld-over"
                                id="delete-all"
                                data-route="{{ route('delete-categories') }}"
                    ...
                    @foreach ($lists as $item)
                        <tr>
                            ...
                            <td style="white-space: normal;">
                                <ul class="mb-0 pl-2">
                                    <li>
                                        Link: <a target="_blank" href="{{ url('category/'.$item->slug) }}">{{ url('category/'.$item->slug) }}</a>
                                    </li>
                                    <li>
                            ...
                            <td>
                                @if ($item->status==1)
                                    <button type="button" class="btn-change btn btn-success has-ripple ld-over" data-id="{{ $item->id }}" data-status="1" data-route="{{ route('change-category') }}">
                                        <div class="ld ld-ring ld-spin"></div>
                                ...
                                @else
                                    <button type="button" class="btn-change btn btn-secondary has-ripple ld-over" data-id="{{ $item->id }}" data-status="0" data-route="{{ route('change-category') }}">
                                        <div class="ld ld-ring ld-spin"></div>
                            ...
                            <td>
                                ...
                                <button type="button" class="btn btn-icon btn-danger btn-delete ld-over" data-id="{{ $item->id }}" data-route="{{ route('delete-category') }}" data-route-data="{{ route('category') }}">
                                    <i class="fas fa-trash-alt"></i>
                                    <div class="ld ld-ring ld-spin"></div>
                                </button>
                            </td>
