            ...
            <tr>
                <th class="d-flex align-items-center">
                    ...
                    <button type="button" class="btn btn-sm btn-danger ld-over"
                            id="delete-all"
                            data-route="{{ route('delete-slides') }}"
            ...
            @if (isset($lists))
                @foreach ($lists as $item)
                    <tr>
                        ...
                        <td>
                            <img class="shadow" src="{{ url($item->image) }}" alt="" width="160px" height="80px">
                        </td>
                        <td style="white-space: normal;">
                            <ul class="mb-0 pl-2">
                                <li>
                                    Link: <b><a target="_blank" href="{{ $item->link }}">{{ $item->link }}</a></b>
                                </li>
                                <li>
                                    Tiêu đề con: <b>{{ $item->sub_title }}</b>
                                </li>
                            </ul>
                        </td>
                        <td>
                            @if ($item->status==1)
                                <button type="button" class="btn-change btn btn-success has-ripple ld-over" data-id="{{ $item->id }}" data-status="1" data-route="{{ route('change-slide') }}">
                                    <div class="ld ld-ring ld-spin"></div>
                            ...
                            @else
                                <button type="button" class="btn-change btn btn-secondary has-ripple ld-over" data-id="{{ $item->id }}" data-status="0" data-route="{{ route('change-slide') }}">
                                    <div class="ld ld-ring ld-spin"></div>
                        ...
                        <td>
                            ...
                            <button type="button" class="btn btn-icon btn-danger btn-delete ld-over" data-id="{{ $item->id }}" data-route="{{ route('delete-slide') }}" data-route-data="{{ route('slide') }}">
                                <i class="fas fa-trash-alt"></i>
                                <div class="ld ld-ring ld-spin"></div>
                            </button>
                        </td>
