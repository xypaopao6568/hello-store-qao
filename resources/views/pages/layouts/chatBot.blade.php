<div>
    <div class="chat-screen">
        ...
        <div class="chat-input hide">
            <input type="text" placeholder="Type a message..." class="form-control" id="userMessage">
            <div class="input-action-icon">
                ...
                <a class="send-button" id="sendMessage"><svg xmlns="http://www.w3.org/2000/svg" width="24"
    ...
    <div class="chat-bot-icon">
        <img src="{{ asset('chatbot/img/we-are-here.svg') }}" />
...
<script>
    document.getElementById('sendMessage').addEventListener('click', function() {
        ...
        userMessageElement.innerHTML = '<strong>Bạn:</strong> ' + userMessage;
        document.querySelector('.chat-box').appendChild(userMessageElement);

        // Xóa nội dung trong ô nhập tin nhắn
        document.getElementById('userMessage').value = '';

        // Xử lý logic của bot và hiển thị phản hồi của bot ở đây
        // Ví dụ: bot trả lời bằng một tin nhắn cứng
        setTimeout(function() {
            var botMessageElement = document.createElement('div');
            botMessageElement.className = 'message';
            botMessageElement.innerHTML =
                '<strong>Bot:</strong> Cảm ơn bạn chúng tôi sẽ sớm liên hệ lại với bạn!';
            document.querySelector('.chat-box').appendChild(botMessageElement);
        }, 1000);
    });
</script>
