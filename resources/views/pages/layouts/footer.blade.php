            ...
            <div class="col-lg-4 col-md-6 col-sm-6">
                <div class="footer__widget">
                    ...
                    <script async defer crossorigin="anonymous"
                        src="https://connect.facebook.net/vi_VN/sdk.js#xfbml=1&version=v10.0&appId=2264561333688241&autoLogAppEvents=1"
            ...
            <div class="col-lg-4 col-md-12">
                <div class="footer__widget">
                    ...
                    <div class="footer__widget__social">
                        ...
                        <a href="https://www.pinterest.com/winshopsvn"><i class="fa fa-pinterest"></i></a>
                    </div>
                </div>
            </div>
        </div>
